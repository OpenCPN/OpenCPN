...
void
MyRoutePrintout::GetPageInfo( int* minPage, int* maxPage, int* selPageFrom, int* selPageTo )
{
    *minPage     = 1;
...
void
MyRoutePrintout::OnPreparePrinting()
{
    pageToPrint = 1;
    wxDC*  dc = GetDC();
...
bool
MyRoutePrintout::OnPrintPage( int page )
{
    wxDC* dc = GetDC();
    pageToPrint = page;
    DrawPage( dc );
...
void
MyRoutePrintout::DrawPage( wxDC* dc )
{
...
bool
RoutePrintSelection::Create( wxWindow* parent, wxWindowID id, const wxString& caption,
...
void
RoutePrintSelection::CreateControls()
{
...
void
RoutePrintSelection::SetColorScheme( ColorScheme cs )
{
    DimeControl( this );
}
...
bool
RoutePrintSelection::ShowToolTips()
{
    return TRUE;
}

void
RoutePrintSelection::SetDialogTitle( wxString title )
{
    SetTitle( title );
}
...
void
RoutePrintSelection::OnRoutepropCancelClick( wxCommandEvent& event )
{
    Hide();
    event.Skip();
}
...
void
RoutePrintSelection::OnRoutepropOkClick( wxCommandEvent& event )
{
