...
#if wxDEBUG_LEVEL > 0
static const wxChar* traceMask = L"jsonval";
static const wxChar* compareTraceMask = L"sameas";
static const wxChar* cowTraceMask = L"traceCOW";
#endif
...
wxString wxJSONValue::AsString() const {
  ...
  switch (data->m_type) {
    ...
    case wxJSONTYPE_MEMORYBUFF:
      ...
      break;
    default:
      s.assign("wxJSONValue::AsString(): Unknown JSON type \'");
...
wxString wxJSONValue::TypeToString(wxJSONType type) {
  static const wxChar* str[] = {
      L"wxJSONTYPE_INVALID",     // 0
      L"wxJSONTYPE_NULL",        // 1
      L"wxJSONTYPE_INT",         // 2
      L"wxJSONTYPE_UINT",        // 3
      L"wxJSONTYPE_DOUBLE",      // 4
      L"wxJSONTYPE_STRING",      // 5
      L"wxJSONTYPE_CSTRING",     // 6
      L"wxJSONTYPE_BOOL",        // 7
      L"wxJSONTYPE_ARRAY",       // 8
      L"wxJSONTYPE_OBJECT",      // 9
      L"wxJSONTYPE_LONG",        // 10
      L"wxJSONTYPE_INT64",       // 11
      L"wxJSONTYPE_ULONG",       // 12
      L"wxJSONTYPE_UINT64",      // 13
      L"wxJSONTYPE_SHORT",       // 14
      L"wxJSONTYPE_USHORT",      // 15
      L"wxJSONTYPE_MEMORYBUFF",  // 16
  };
...
int wxJSONValue::AddComment(const wxString& str, int position) {
  ...
  if (str[1] == '/') {  // a C++ comment: check that it ends with '\n'
    wxLogTrace(traceMask, "     C++ comment");
