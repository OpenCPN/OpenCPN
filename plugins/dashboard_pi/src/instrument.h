...
enum DASH_CAP {
  ...
  OCPN_DBP_STC_HMV,    ///< Magnetic variation from NMEA device if available (not from WMM)
  ...
  OCPN_DBP_STC_TWD,    ///< True Wind Direction (from NMEA device if available, otherwise TWA + magnetic variation)
