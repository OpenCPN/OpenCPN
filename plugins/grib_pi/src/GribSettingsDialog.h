...
struct GribOverlaySettings {
  ...
  enum SettingsType {
    ...
    WIND_WAVES,
    SWELL_WAVES,
    COMBINED_WAVE_STEEPNESS,  ///< Derived: H/L for combined waves
    WIND_WAVE_STEEPNESS,      ///< Derived: H/L for wind waves
    SWELL_WAVE_STEEPNESS,     ///< Derived: H/L for swell waves
    CURRENT,
    PRECIPITATION,
    CLOUD,
    AIR_TEMPERATURE,
  ...
  enum Units6 { JPKG };
  enum Units7 { DBZ };
  enum Units8 { RATIO, PERCENTAGE_STEEP };  ///< Wave steepness units
  ...
  enum UnitType {
    ...
    UNIT_TYPE_STEEPNESS = 9      ///< Wave steepness units (ratio, percentage)
  };
