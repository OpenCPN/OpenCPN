...
enum {
  ...
  /**
   * Mean direction of combined wind waves and swell in degrees
   *
   * Direction from which the combined waves are coming, measured clockwise
   * from true north (meteorological convention). This represents the dominant
   * wave direction considering both wind waves and swell.
   */
  Idx_WVDIR,

  /**
   * Mean period of combined wind waves and swell in seconds
   *
   * The average time interval between successive wave crests, considering
   * both wind waves and swell. Typical values range from 3-20 seconds.
   * Shorter periods (3-7s) indicate wind waves, longer periods (8-20s)
   * indicate swell dominance.
   */
  Idx_WVPER,
