...
#define ID_CB_COMBINED_WAVE_STEEPNESS 1078  // Combined wave steepness
#define ID_CB_WIND_WAVE_STEEPNESS 1079      // Wind wave steepness
#define ID_CB_SWELL_WAVE_STEEPNESS 1080     // Swell wave steepness
