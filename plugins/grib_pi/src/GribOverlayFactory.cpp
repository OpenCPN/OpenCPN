...
ColorMap *ColorMaps[] = {CurrentMap, GenericMap, QuickscatMap, AirTempMap, SeaTempMap, PrecipitationMap, CloudMap};

enum {
    GENERIC_GRAPHIC_INDEX, QUICKSCAT_GRAPHIC_INDEX, AIRTEMP__GRAPHIC_INDEX, SEATEMP_GRAPHIC_INDEX, 
