...
#LangString LangDialog_Title ${LANG_ENGLISH} "OpenCPN 2.2.1018 Installation"
LangString LangDialog_Title ${LANG_GERMAN} "OpenCPN 2.2.1018 Installation"
...
#LangString Uninstall_Link ${LANG_ENGLISH} "Uninstall OpenCPN 2.2.1018"
LangString Uninstall_Link ${LANG_GERMAN} "OpenCPN 2.2.1018 deinstallieren"
...
#LangString Page_TypeInst_Subtitle_Exists ${LANG_ENGLISH} "OpenCPN 2.2.1018 is already installed.$\r$\nChoose how you want to install OpenCPN."
LangString Page_TypeInst_Subtitle_Exists ${LANG_GERMAN} "OpenCPN 2.2.1018 ist bereits installiert.$\r$\nWählen Sie aus, wie Sie OpenCPN installieren möchten."	

#LangString Label_TypeInst_Reinstall_Text ${LANG_ENGLISH} "OpenCPN 2.2.1018 is already installed on your system. You can reinstall the version now using the previous settings. If you wish to install the program with different settings, cancel installation and un-install the existing version first. Click Next to continue."
LangString Label_TypeInst_Reinstall_Text ${LANG_GERMAN} "OpenCPN 2.2.1018 ist bereits auf Ihrem System installiert. Sie können die Version jetzt mit den vorherigen Einstellungen erneut installieren. Wenn Sie das Programm mit anderen Einstellungen neu installieren möchten, brechen Sie die Installation ab und deinstallieren Sie zuerst die vorhandene Version. Klicken Sie auf Weiter, um fortzufahren."
...
#LangString Finish_Link_URL ${LANG_ENGLISH} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=2.2.1018"
LangString Finish_Link_URL ${LANG_GERMAN} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=2.2.1018"
