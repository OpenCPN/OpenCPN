...
LangString LangDialog_Title ${LANG_GERMAN} "OpenCPN 3.3.2303 Installation"
...
LangString Uninstall_Link ${LANG_GERMAN} "OpenCPN 3.3.2303 deinstallieren"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_GERMAN} "OpenCPN 3.3.2303 ist bereits installiert.$\r$\nWählen Sie aus, wie Sie OpenCPN installieren möchten."	
...
LangString Finish_Link_URL ${LANG_GERMAN} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.3.2303"
...
LangString ^NameDA ${LANG_GERMAN} "OpenCPN Version 3.3.2303"
