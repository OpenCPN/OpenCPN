...
LangString LangDialog_Title ${LANG_FRENCH} "OpenCPN 3.3.2303 Installation"
...
LangString Uninstall_Link ${LANG_FRENCH} "Désinstalle  OpenCPN 3.3.2303"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_FRENCH} "OpenCPN 3.3.2303 est déjà installé.$\r$\nChoisir comment vous voulez installer OpenCPN."
...
LangString Finish_Link_URL ${LANG_FRENCH} "http://opencpn.info/?ref=installer&utilisateurr=$USERS_NAME&lang=$REG_LANG&version=3.3.2303"
...
LangString ^NameDA ${LANG_FRENCH} "OpenCPN Version 3.3.2303"
