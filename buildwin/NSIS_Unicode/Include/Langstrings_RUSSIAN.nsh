...
LangString LangDialog_Title ${LANG_RUSSIAN} "OpenCPN 3.3.2303 Installation"
...
LangString Uninstall_Link ${LANG_RUSSIAN} "Uninstall OpenCPN 3.3.2303"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_RUSSIAN} "OpenCPN 3.3.2303 is already installed.$\r$\nChoose how you want to install OpenCPN."
...
LangString Label_TypeInst_Reinstall_Text ${LANG_RUSSIAN} "OpenCPN 3.3.2303 is already installed on your system. You can reinstall the version now using the previous settings. If you wish to install the program with different settings, cancel installation and un-install the existing version first. Click Next to continue."
...
LangString Finish_Link_URL ${LANG_RUSSIAN} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.3.2303"
...
LangString ^NameDA ${LANG_RUSSIAN} "OpenCPN Версия 3.3.2303"
