...
LangString LangDialog_Title ${LANG_CHINESETW} "OpenCPN 3.3.2303 安裝"
...
LangString Uninstall_Link ${LANG_CHINESETW} "移除安裝 OpenCPN 3.3.2303"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_CHINESETW} "OpenCPN 3.3.2303 已安裝.$\r$\n選擇您要如何安裝 OpenCPN."
...
LangString Label_TypeInst_Reinstall_Text ${LANG_CHINESETW} "OpenCPN 3.3.2303 已經安裝在您的系統上. 您可以使用先前的設定值重新安裝此版本. 如果您希望以不同的設定值來安裝, 請先移除現有版本, 按下一步繼續."
...
LangString Finish_Link_URL ${LANG_CHINESETW} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.3.2303"
...
LangString ^NameDA ${LANG_CHINESETW} "OpenCPN 版本 3.3.2303"
