...
LangString LangDialog_Title ${LANG_CZECH} "Instalace OpenCPN 3.3.2303"
...
LangString Uninstall_Link ${LANG_CZECH} "Odinstalovat OpenCPN 3.3.2303"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_CZECH} "OpenCPN 3.3.2303 je již nainstalováno.$\r$\nVyberte, jak chcete OpenCPN nainstalovat."
...
LangString Label_TypeInst_Reinstall_Text ${LANG_CZECH} "OpenCPN 3.3.2303 je již na Vašem systému nainstalováno. Nyní můžete přeinstalovat verzi s původní nastavením. Pokud chcete nainstalovat program s jiným nastavením, zrušte instalaci a odinstalujte napřed původní verzi. Klikněte na Další pro pokračování."
...
LangString Finish_Link_URL ${LANG_CZECH} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.3.2303"
...
LangString ^NameDA ${LANG_CZECH} "OpenCPN Verze 3.3.2303"
