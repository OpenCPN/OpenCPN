...
public class BluetoothSPP {
    ...
    public BluetoothSPP(Context context) {
        Log.i("DEBUGGER_TAG", "BluetoothSPP ctor");
    ...
    private final Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            Log.i("DEBUGGER_TAG", "MESSAGE_TOAST");
            ...
            Log.i("DEBUGGER_TAG", "MESSAGE_STATE_CHANGE");
                ...
                if(isConnected && msg.arg1 != BluetoothState.STATE_CONNECTED) {
                    ...
                    Log.i("DEBUGGER_TAG", "Disconnected");
                    isConnected = false;
                    mDeviceName = null;
                    mDeviceAddress = null;
                }
