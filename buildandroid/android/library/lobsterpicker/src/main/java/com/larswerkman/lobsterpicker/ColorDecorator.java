 ...
 * to the {@link LobsterPicker}. {@link com.larswerkman.lobsterpicker.LobsterPicker.Chain}
...
public interface ColorDecorator {
     ...
     *
     * @param chain {@link com.larswerkman.lobsterpicker.LobsterPicker.Chain} back to the attacked parent.
     * @param color new color
     */
    void onColorChanged(LobsterPicker.Chain chain,  int color);
}
