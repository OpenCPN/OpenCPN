...
As of 5.8 handling SignalK messages is not possible, see 
https://github.com/OpenCPN/OpenCPN/issues/3381[the OpenCPN issue].
From 5.10 handling signalk messages goes like:
```
