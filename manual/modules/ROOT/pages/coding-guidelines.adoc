...
. Constants:
Pascal case +a 'k' prefix: `kSomeConstantValue`
...
of which related to the underlying python installation.
See the xref:pre-commit-win.adoc[pre-commit windows page]
