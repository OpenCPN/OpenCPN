...
Using https://pre-commit.com/  on windows requires sopme extra handling, most
...
. In app settings, click Modify 
. Check the _Py Launcher checkbox_, click Next
. Click Install.
. On the command line in the plugin directory install pre-commit using
