...
// 1. "UTC": format date/time in UTC.
// 2. "Local Time": format date/time in local time as configured in the system.
// 3. "LMT": Local Mean Time, based on the longitude.
...
// @param time_zone The timezone to use when formatting the date/time.
...
extern DECL_EXP wxString TToString(
    ...
    const wxString format_string = DT_LONG_DATE_TIME,
