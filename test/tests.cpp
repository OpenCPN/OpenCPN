...
TEST_F(TToStringTest, LMTTimeZoneOneHourEast) {
  ...
  wxString result = ocpn::TToString(testDate, "%A, %B %d, %Y %I:%M:%S %p",
                                    DT_TZ_LMT, 15.0);  // 15 degrees East
...
TEST_F(TToStringTest, LMTTimeZone30MinEast) {
  ...
  testDate.MakeFromTimezone(wxDateTime::UTC);
  wxString result = ocpn::TToString(testDate, "%A, %B %d, %Y %I:%M:%S %p",
                                    DT_TZ_LMT, 7.5);  // 7.5 degrees East
...
TEST_F(TToStringTest, LMTTimeZoneWest) {
  ...
  testDate.MakeFromTimezone(wxDateTime::UTC);
  wxString result = ocpn::TToString(testDate, "%A, %B %d, %Y %I:%M:%S %p",
                                    DT_TZ_LMT, -37.5);  // 37.5 degrees West
...
TEST_F(TToStringTest, CustomFormatStringUTC) {
  ...
  testDate.MakeFromTimezone(wxDateTime::UTC);
  wxString result =
      ocpn::TToString(testDate, "%Y-%m-%d %H:%M:%S", DT_TZ_UTC, NAN);
