...
public:
  ...
  bool CrossesLandWithDistanceField(double &lat1, double &lon1, double &lat2, double &lon2);
  ...
  void CancelLoading();
     ...
     * @return Distance to nearest coastline in nautical miles. Positive values indicate water.
     */
