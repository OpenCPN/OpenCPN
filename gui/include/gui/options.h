...
// Widget identifiers used by wxWidgets. A plain enum is intentionally used
// instead of enum class because wxWidgets expects IDs to be implicitly
// convertible to int (EVT_* macros, SetOwner(), control constructors, etc.).
// Using enum class would require widespread static_cast<int>() calls.
enum {
  ADVANCEWAYPOINT,
  APPLY = 10000,
  ATONTEXTCHECKBOX,
  ...
  ZTCCHECKBOX,
  DELETECHECKBOX,
  NATIONALTEXTCHECKBOX,
  TRUESHOWCHECKBOX,
  MAGSHOWCHECKBOX,
  MAGAPBCHECKBOX,
  MOBILEBOX,
  REPONSIVEBOX,
  SIZEMANUALRADIOBUTTON,
  OPWAYPOINTRANGERINGS,
  xOK,
  BT_SCANTIMER,
  TRACKROTATETIME,
  TRACKROTATEUTC,
  ...
  INLANDECDISBOX,
  ROLLOVERBOX,
  SOGCOGFROMLLCHECKBOX,
  SOGCOGDAMPINTTEXTCTRL,
  // LIVE ETA OPTION
  CHECK_LIVEETA,
  DEFAULT_BOAT_SPEED,
  SCREENCONFIG1,
