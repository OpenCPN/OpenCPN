...
/**
 *
 * A label, a text entry and an EditIcon allows for user text input
 *
 *               -------------------------------    -----
 *   Label:      |                             |    |   |
 *               -------------------------------    -----
 *
 *   The rightmost icon is either a check mark or a pen icon, the entry
 *   is a regular wxTextCtrl.
 */
