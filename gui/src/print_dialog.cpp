...
PrintDialog::PrintDialog(wxPrintOrientation orientation) {
  wxPrintData data;
  data.SetOrientation(orientation);
  m_print_data = wxPrintDialogData(data);
}

PrintDialog& PrintDialog::GetInstance(wxPrintOrientation orientation) {
  static PrintDialog instance(orientation);
  return instance;
}
