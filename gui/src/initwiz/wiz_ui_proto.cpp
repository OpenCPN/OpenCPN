...
FirstUseWiz::FirstUseWiz( wxWindow* parent, wxWindowID id, const wxString& title, const wxBitmap& bitmap, const wxPoint& pos, long style )
{
	...
	m_stDepth = new wxStaticText( sbSizerUnits->GetStaticBox(), wxID_ANY, _("Depth"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stDepth->Wrap( -1 );
	...
	m_cDepth = new wxChoice( sbSizerUnits->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_cDepthNChoices, m_cDepthChoices, 0 );
	m_cDepth->SetSelection( 0 );
	fgSizerUnits->Add( m_cDepth, 0, wxALL, 5 );

	m_stDistance = new wxStaticText( sbSizerUnits->GetStaticBox(), wxID_ANY, _("Distance"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stDistance->Wrap( -1 );
	fgSizerUnits->Add( m_stDistance, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

	wxString m_cDistanceChoices[] = { _("Nautical miles"), _("Statute miles"), _("Kilometers"), _("Meters") };
	int m_cDistanceNChoices = sizeof( m_cDistanceChoices ) / sizeof( wxString );
	m_cDistance = new wxChoice( sbSizerUnits->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_cDistanceNChoices, m_cDistanceChoices, 0 );
	m_cDistance->SetSelection( 0 );
	fgSizerUnits->Add( m_cDistance, 0, wxALL, 5 );

	m_stSpeed = new wxStaticText( sbSizerUnits->GetStaticBox(), wxID_ANY, _("Speed"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stSpeed->Wrap( -1 );
	...
	m_cSpeed = new wxChoice( sbSizerUnits->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_cSpeedNChoices, m_cSpeedChoices, 0 );
	...
	wxString m_cPositionChoices[] = { _("Degrees, decimal minutes (DD MM.MM)"), _("Decimal degrees (DD.DDDDD)"), _("Degrees, minutes, seconds (DD MM SS)"), wxEmptyString };
	int m_cPositionNChoices = sizeof( m_cPositionChoices ) / sizeof( wxString );
	m_cPosition = new wxChoice( sbSizerUnits->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_cPositionNChoices, m_cPositionChoices, 0 );
	...
	m_cbShowTrue = new wxCheckBox( sbSizerUnits->GetStaticBox(), wxID_ANY, _("Show true headings and bearings"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_cbShowMagnetic = new wxCheckBox( sbSizerUnits->GetStaticBox(), wxID_ANY, _("Show magnetic headings and bearings"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	// Connect Events
	this->Connect( wxEVT_INIT_DIALOG, wxInitDialogEventHandler( FirstUseWiz::OnInitDialog ) );
	this->Connect( wxID_ANY, wxEVT_WIZARD_CANCEL, wxWizardEventHandler( FirstUseWiz::OnWizardCancel ) );
	this->Connect( wxID_ANY, wxEVT_WIZARD_FINISHED, wxWizardEventHandler( FirstUseWiz::OnWizardFinished ) );
	this->Connect( wxID_ANY, wxEVT_WIZARD_HELP, wxWizardEventHandler( FirstUseWiz::OnWizardHelp ) );
	this->Connect( wxID_ANY, wxEVT_WIZARD_PAGE_CHANGED, wxWizardEventHandler( FirstUseWiz::OnWizardPageChanged ) );
	this->Connect( wxID_ANY, wxEVT_WIZARD_PAGE_CHANGING, wxWizardEventHandler( FirstUseWiz::OnWizardPageChanging ) );
	this->Connect( wxID_ANY, wxEVT_WIZARD_PAGE_SHOWN, wxWizardEventHandler( FirstUseWiz::OnWizardPageShown ) );
	m_btnRescanSources->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FirstUseWiz::m_btnRescanSourcesOnButtonClick ), NULL, this );
	m_btnAddChartDir->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FirstUseWiz::m_btnAddChartDirOnButtonClick ), NULL, this );
}

FirstUseWiz::~FirstUseWiz()
{
	// Disconnect Events
	this->Disconnect( wxEVT_INIT_DIALOG, wxInitDialogEventHandler( FirstUseWiz::OnInitDialog ) );
	...
	this->Disconnect( wxID_ANY, wxEVT_WIZARD_HELP, wxWizardEventHandler( FirstUseWiz::OnWizardHelp ) );
	this->Disconnect( wxID_ANY, wxEVT_WIZARD_PAGE_CHANGED, wxWizardEventHandler( FirstUseWiz::OnWizardPageChanged ) );
	this->Disconnect( wxID_ANY, wxEVT_WIZARD_PAGE_CHANGING, wxWizardEventHandler( FirstUseWiz::OnWizardPageChanging ) );
	this->Disconnect( wxID_ANY, wxEVT_WIZARD_PAGE_SHOWN, wxWizardEventHandler( FirstUseWiz::OnWizardPageShown ) );
	m_btnRescanSources->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FirstUseWiz::m_btnRescanSourcesOnButtonClick ), NULL, this );
	m_btnAddChartDir->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( FirstUseWiz::m_btnAddChartDirOnButtonClick ), NULL, this );
